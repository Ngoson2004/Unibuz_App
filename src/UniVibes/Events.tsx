...
import image1 from "../media/artTribe.png";
  ...
  return (
    <div className="min-h-screen bg-slate-100">
      ...
      <Modal show={openModal} onClose={() => closeModal()} popup>
        ...
        <Modal.Footer>
          <Button
            className="bg-[#3224f2] text-[#cbfd80] sm:h-auto sm:w-auto sm:py-1.5"
            size="md"
      ...
      <div className="relative mx-auto py-44 lg:px-20 xl:px-52">
        ...
        <Carousel
          leftControl={<FaCircleArrowLeft className="h-10 w-10" />}
          rightControl={<FaCircleArrowRight className="h-10 w-10" />}
        >
