...
import about_banner from "../media/about_banner.png";
import mission from "../media/mission.png";
import vision from "../media/vision.png";
import story from "../media/story.png";
import suzanne from "../media/suzanne.png";
import ellipse1 from "../media/ellipse1.png";
    ...
    <div>
      ...
      <div className="isolate bg-white">
        ...
        <div className="relative mt-16 w-dvw place-content-center sm:mt-28">
          ...
          <div className="grow">
            <img
              className="absolute top-0 z-[-1] hidden h-full w-full object-cover sm:block"
              src={about_banner}
              alt="Unibuz Hero Banner"
            />
          </div>
      ...
      <div className="relative my-20 grid grid-rows-3 gap-20 p-10 sm:my-auto sm:gap-40 sm:p-[90px]">
        <div className="flex h-fit flex-grow flex-col gap-20 sm:h-[503px] sm:flex-1 sm:flex-row">
      ...
      <div className="relative my-40 flex h-fit w-dvw flex-grow place-content-center rounded-[40px] bg-[#EAE9FE] sm:h-[622px] flex-1">
        <img
          src={ellipse1}
          alt="ellipse1"
          className="hidden sm:block absolute left-0 top-0 h-[200px] w-[200px] object-cover"
        />
        <img
          src={rectangle}
          alt="rectangle"
          className="hidden sm:block absolute left-28 top-28 h-[100px] w-[100px] object-cover"
        />
        <svg
        ...
        <img
          src={rectangle}
          alt="rectangle"
          className="absolute bottom-10 left-0 sm:bottom-20 sm:left-96 h-[50px] w-[50px] object-cover"
        />

        <Card className="my-5 sm:my-12 w-10/12 sm:w-5/12">
          <div className="flex flex-col space-y-8">
            <Avatar img={suzanne} size="xl" />
            <h1 className="text-center font-satoshi-md text-sm sm:text-[24px] text-[#3224f2]">
              Suzanne Soares · Founder & CEO
            </h1>
            <p className="mx-auto sm:mx-5 text-balance text-center font-satoshi text-sm sm:text-lg text-[#060028]">
              “Unibuz is the{" "}
        ...
        <img
          src={polygon}
          alt="polygon"
          className="absolute right-10 top-20 sm:right-96 sm:top-28 h-[50px] w-[50px] object-cover"
        />
        ...
        <img
          src={polygon}
          alt="polygon"
          className="hidden sm:block absolute bottom-28 right-28 h-[100px] w-[100px] object-cover"
        />
        <img
          src={ellipse2}
          alt="ellipse2"
          className="hidden sm:block absolute bottom-0 right-0 h-[200px] w-[200px] object-cover"
        />
      </div>
      <Footers />
    </div>
