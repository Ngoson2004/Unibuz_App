...
import banner_img from "../media/feature_banner.png";
import tribe_img from "../media/feature_tribe.png";
import event_img from "../media/feature_event.png";
import message_img from "../media/feature_message.png";
import market_img from "../media/feature_market.png";
    ...
    <div>
      ...
      <div className="isolate bg-white">
        ...
        >
          ...
          <div className="flex h-fit flex-grow flex-grow flex-col gap-20 sm:h-[503px] sm:flex-1 sm:flex-row">
            <div className="h-full flex-col items-center">
              <h1 className="mb-5 font-clash-grotesk-semibold text-5xl">
                What's On
              </h1>
          ...
          <div className="flex h-fit flex-grow flex-grow flex-col gap-20 sm:h-[503px] sm:flex-1 sm:flex-row">
            ...
            <div className="h-full flex-col items-center">
              ...
              <div className="flex items-center gap-5 font-satoshi text-[20px] text-[#3224f2]">
                <RiLockPasswordLine className="h-24 w-24 text-[#3224f2]" />
                <p>
