      ...
      <div className="isolate bg-white">
        ...
        <div className="relative w-full sm:grid sm:grid-cols-2">
          <img
            ...
            alt="Unibuz Hero Banner"
          />
          <div className="mt-52 h-max place-content-center items-center bg-transparent sm:m-[72px] sm:h-[508px] sm:w-[523px]">
        ...
        <div className="pt-56 sm:pt-0">
          <div
            id="feature"
            className="mb-8 grid grid-rows-1 gap-12 p-6 sm:my-auto sm:mb-0 sm:p-[90px]"
          >
            ...
            <div className="flex h-fit grow flex-col gap-20 sm:h-[503px] sm:flex-1 sm:flex-row">
              ...
              <div className="flex h-full flex-col">
                <h1 className="mb-8 text-center font-clash-grotesk-semibold text-[28px] leading-[32px] sm:text-left sm:text-5xl">
                  Tribes
                </h1>
                <div className="flex flex-col gap-4 sm:flex-row">
                  <p className="order-2 mb-4 max-w-[566px] font-satoshi text-base leading-6 sm:order-1 sm:mb-8 sm:text-[20px]">
                ...
                <div className="mb-3 flex items-center gap-5 font-satoshi text-base leading-6 text-[#3224f2] sm:mb-5 sm:text-[20px]">
                  <div className="flex h-[48px] w-[54px] items-center justify-center">
                    <svg
                ...
                <div className="flex items-center gap-5 font-satoshi text-base leading-6 text-[#3224f2] sm:text-[20px]">
            ...
            <div className="flex h-fit grow flex-col gap-20 sm:h-[503px] sm:flex-1 sm:flex-row">
              <div className="flex h-full flex-col">
                ...
                <div className="flex flex-col gap-4 sm:flex-row">
                  <p className="order-2 mb-4 max-w-[566px] font-satoshi text-base leading-6 sm:order-1 sm:mb-8 sm:text-[20px]">
                    Stay in the loop with events that matter to you. Unibuz
                    makes it easy to find, save, and manage your campus
            ...
            <div className="flex h-fit grow flex-col gap-20 sm:h-[503px] sm:flex-1 sm:flex-row">
              ...
              <div className="flex h-full flex-col">
                ...
                <div className="flex items-center gap-5 font-satoshi text-base leading-6 text-[#3224f2] sm:text-[20px]">
                  <div className="flex h-[48px] w-[57px] items-center justify-center">
                    <RiLockPasswordLine className="size-6 text-[#3224f2]" />
                  </div>
                  <p>
            ...
            <div className="flex h-fit grow flex-col gap-20 sm:h-[503px] sm:flex-1 sm:flex-row">
              <div className="flex h-full flex-col">
                ...
                <div className="mb-3 flex items-center gap-5 font-satoshi text-base leading-6 text-[#3224f2] sm:mb-5 sm:text-[20px]">
                  <div className="flex h-[48px] w-[52px] items-center justify-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                ...
                <div className="flex items-center gap-5 font-satoshi text-base leading-6 text-[#3224f2] sm:text-[20px]">
                  ...
                  <p>
                    <strong className="font-satoshi-bold">Search</strong> by
                    item, location, or university to find exactly what you need,
