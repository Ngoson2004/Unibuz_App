...
export default function GoodVibeGuidePage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    navigate("/auth/sign-in", { state: { showToast: true } });
  };
    ...
    <div className="h-dvh grid-cols-2 gap-5 sm:grid">
      <div>
        <form
          ...
          className="sm:px-auto mx-auto grid max-w-4xl grid-rows-1 gap-5 px-5 sm:px-10 py-16 lg:py-32"
        >
          <div className="flex flex-col space-y-3 my-5">
            <div>
              <PiBookBookmarkFill className="size-10 text-[#3B4FE6]" />
            </div>
            <div>
          ...
          <Card className="mb-5">
            <div className="px-5 overflow-y-auto h-72">
              <ul className="divide-y divide-gray-200 dark:divide-gray-700">
                <li className="flex items-center justify-between py-4">
                  <div className="flex flex-col">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      Your race, ethnicity, religion, gender, or
                      sexuality---here, you're safe and valued.
                    </p>
                  </div>
                </li>
                <li className="flex items-center justify-between py-4">
                ...
                <li className="flex items-center justify-between py-4">
                  <div className="flex flex-col">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      We want to keep our space safe and sound, so anything
                      that's against the law is a off-limits.
                    </p>
                  </div>
                </li>
                <li className="flex items-center justify-between py-4">
                ...
                <li className="flex items-center justify-between py-4">
                  <div className="flex flex-col">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      We love originality. So remember, if it's not yours, give
                      a shout-out to the creator or better yet simply share your
                      own stuff.
                    </p>
                  </div>
                </li>
                <li className="flex items-center justify-between py-4">
                  <div className="flex flex-col">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      We're all trust here. Share your own stories, but let's
                      not spill the beans on someone else's details without an
                      'okay' from them.
                    </p>
                  </div>
                </li>
                ...
                <li className="flex items-center justify-between py-4">
                  <div className="flex flex-col">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      This is a place for all voices and views. Let's embrace
                      the mix and without any 'us' vs. 'them' --- everyone's
                      welcome.
                    </p>
                  </div>
                </li>
                <li className="flex items-center justify-between py-4">
                  <div className="flex flex-col">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      Stick to the rules set by the house, including the
                      community guidelines and terms of service. They're here to
                ...
                <li className="flex items-center justify-between py-4">
                  <div className="flex flex-col">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      Facts are our friends. If you've heard misinformation,
                      let's not spread it out. If you have to share, make sure
                      you have the source to verify.
                    </p>
                  </div>
                </li>
                <li className="flex items-center justify-between py-4">
                  <div className="flex flex-col">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      ...
                      spamming---keep adverts to the designated spaces and stay
                      on topic.
                    </p>
                  </div>
                </li>
