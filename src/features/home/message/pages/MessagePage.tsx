                  ...
                  {friends.map((friend) => (
                    ...
                    >
                      ...
                      <Button gradientMonochrome="lime" className="px-0.5" pill>
                        <FiPlus className="size-3 text-[#3224f2] sm:size-6" />
                      </Button>
                    </li>
                  ))}
                </ul>
                      ...
                      >
                        ...
                        {message.image && (
                          <img
                            src={message.image}
                            alt="attachment"
                            className="max-w-md justify-self-end rounded-lg"
                          />
                        )}
                        {message.reaction && (
            ...
            <Modal.Body>
              ...
              <div className="flex-inline mt-5 flex gap-2">
                ...
                <Button
                  ...
                  pill
                >
                  <IoMdSend className="size-5 text-[#cbfd80]" />
                </Button>
              </div>
          ...
          {selectedProfile && (
            <div className="flex items-center rounded-xl bg-white p-4">
              <Dropdown
                ...
                renderTrigger={() => (
                  <div>
                    <FiPlus className="mr-2 size-8 text-[#3224f2] hover:cursor-pointer hover:text-[#cbfd80]" />
                  </div>
                )}
              >
              ...
              <div className="flex-1 flex-col items-end gap-3">
                {newImage && (
                  <img
                    src={newImage}
                    alt="attachment"
              ...
              <Tooltip
                ...
                trigger="click"
              >
                <MdOutlineEmojiEmotions className="mx-2 size-8 text-[#3224f2] hover:cursor-pointer hover:text-[#cbfd80]" />
              </Tooltip>
