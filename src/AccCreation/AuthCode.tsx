    ...
    return (
      <div>
        ...
        <form
          ...
          className="sm:px-auto mx-auto grid max-w-md grid-rows-1 gap-5 px-5 py-32 sm:py-48 lg:py-56 inline-block align-middle"
        >
          <legend>
            <svg
            ...
            <div className="flex justify-between">
              {[...Array(5)].map((_, index) => (
                <TextInput
                  ...
                  type="text"
                  maxLength={1}
                  className="h-12 w-12 rounded-lg border-2 border-[#3B4FE6] text-center text-lg font-bold"
                  required
                />
              ))}
            </div>
